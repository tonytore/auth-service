...
const logger = winstonLogger(app_config_1.default.LOKI_URL || "http://localhost:3100", app_config_1.default.APP_NAME || "auth-service", app_config_1.default.LOG_LEVEL || "info", app_config_1.default.NODE_ENV || "development");
