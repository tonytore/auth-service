...
const not_found_error_1 = __importDefault(require("./utils/error/not_found_error"));
...
app.listen(app_config_1.default.PORT, () => {
    logger_1.logger.info(`Auth Service running on port http://localhost:${app_config_1.default.PORT}`);
});
