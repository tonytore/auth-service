...
exports.authController = {
    register: (0, catch_async_1.default)(async (req, res) => {
        ...
        return (0, response_helper_1.successResponse)(res, "User Registered Successfully", user, 201);
    }),
    login: (0, catch_async_1.default)(async (req, res) => {
        ...
        res.cookie("accessToken", accessToken, app_config_1.default.ACCESS_COOKIE_OPTIONS);
        ...
        return (0, response_helper_1.successResponse)(res, "User Logged In Successfully", user, 200);
    }),
